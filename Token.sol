...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDCOIN = IERC20(0x55d398326f99059fF775485246999027B3197955);
...
contract Token is IERC20, Ownable {
    ...
    // CHANGE
    address REWARDCOIN = 0x55d398326f99059fF775485246999027B3197955;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; // 2% 20,000,000
    uint256 public _maxWalletSize = (_totalSupply * 40) / 1000; // 4% 40,000,000
    ...
    uint256 totalFee = 600; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(OwnerAddress);
